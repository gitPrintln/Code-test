...
public class 자동완성3차 {
    ...
    class Solution {
        ...
        static class Trie {
            ...
            public void insert(String word) {
                ...
                for (char c : word.toCharArray()) {
                    ...
                    node.count++;  // 이 노드를 지나가는 단어의 수 증가
                }
            }

            // 단어를 찾을 때 몇 글자가 필요한지 계산
            public int findMinLength(String word) {
                ...
                for (char c : word.toCharArray()) {
                    ...
                    length++;
                    if (node.count == 1) {
                        break;  // 이 노드를 지나가는 단어가 1개일 경우 더 이상 입력하지 않아도 됨
                    }
                }
                return length;
            }
        ...
        public int solution(String[] words) {
            ...
            // 각 단어에 대해 최소 입력 길이를 구하고 더함
            for (String word : words) {
                totalLength += trie.findMinLength(word);
            }
