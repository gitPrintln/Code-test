...
public class 순위검색2 {
    ...
    class Solution {
        public int[] solution(String[] info, String[] query) {
            ...
            // 모든 조합을 생성하여 infoMap에 점수 리스트 저장
            for (String inf : info) {
                String[] splitInfo = inf.split(" ");
                int score = Integer.parseInt(splitInfo[4]);
                String[] conditions = {splitInfo[0], splitInfo[1], splitInfo[2], splitInfo[3]};
            ...
            // 각 쿼리에 대해 조건을 파싱하여 해당하는 점수 리스트에서 이진 탐색
            for (int i = 0; i < query.length; i++) {
                ...
                // 조건에 맞는 점수 리스트 가져오기
                List<Integer> scoreList = infoMap.getOrDefault(key, new ArrayList<>());

                // 이진 탐색으로 score 이상인 점수의 개수를 찾음
