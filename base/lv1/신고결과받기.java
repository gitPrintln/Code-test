...
public class 신고결과받기 {
    ...
    class Solution {
        public int[] solution(String[] id_list, String[] report, int k) {
            ...
            // users의 idMap.get(str[0])번째 index에 reportList에 피신고인 추가
            // users의 idMap.get(str[1])번째 index에 reportedList에 신고인 추가
            for(String re : report){
                String[] str = re.split(" ");
                users.get(idMap.get(str[0])).reportList.add(str[1]);
                users.get(idMap.get(str[1])).reportedList.add(str[0]);
            }
